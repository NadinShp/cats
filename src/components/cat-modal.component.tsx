...
import { useSingleCatData } from '../api/use-single-data-cat.hook';
...
export const CatModal: FC<CatModalProps> = ({}) => {
  ...
  return (
    <Modal show={isOpened} onClose={closeModal} className="w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
      <Modal.Header>
        {isLoading
          ? 'Loading...'
